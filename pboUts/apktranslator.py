...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Terjemahan Inggris').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Terjemahan Korea').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Terjemahan Jepang').grid(row=5, column=0,
            sticky=W, padx=5, pady=5)
